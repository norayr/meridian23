...
# hash value = 203037822
lclstrconsts.rshelphelpfordirectivenotfoundindatabase='Help for directive'+
' %s%s%s not found in Database %s%s%s.'


# hash value = 211593214
lclstrconsts.rshelphelpfordirectivenotfound='Help for directive %s%s%s no'+
't found.'
...
lclstrconsts.lisprogramfilenotfound='program file not found %s'


# hash value = 171227939
lclstrconsts.liscannotexecute='can not execute %s'


# hash value = 218345129
lclstrconsts.liscefilter='(filter)'
